...
*/
    ...
    GPIOPinWrite(GPIOA0_BASE, 0x20, 0); // OC  P60
    GPIOPinWrite(GPIOA2_BASE, 0x40, 0x00); // DC P15
    MAP_SPIDataPut(GSPI_BASE, tmp);
    MAP_SPIDataGet(GSPI_BASE, &trash);
    GPIOPinWrite(GPIOA0_BASE, 0x20, 0x20); //OC
...
*/
    ...
    unsigned long tmp = (unsigned long)c;
       MAP_SPICSEnable(GSPI_BASE);
       GPIOPinWrite(GPIOA0_BASE, 0x20, 0); // OC
...
*/
  ...
  GPIOPinWrite(GPIOA1_BASE, 0x10, 0);   // RESET = RESET_LOW  P3
